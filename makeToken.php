...
<h3>Please specify excercise</h3>
 <form action="/joanaChall/makeToken.php">
...
if(isset($_GET['excercise']))
{
	...
	//Find the node of the excercise
	...
	$excercise = $ex. "/excercise.html";
	if(!file_exists($excercise)){
		$template_excercise = '<!DOCTYPE html><html><head><meta name="Excercise" content="width=device-width, initial-scale=1"></head><body><h1>Excercise</h1><h2>Header Goes here</h2><p>Description goes here</p><a href="/joanaChall/'.$ex.'/challenge.tar.gz" download="challenge.tar.gz">Download Excercise</a></body></html>';
		$exfile = fopen($excercise,"w");
		fwrite($exfile,$template_excercise);
		fclose($exfile);
	}else{echo "Nope!";}
